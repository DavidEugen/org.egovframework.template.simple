...
import org.egovframe.cmm.util.EgovIdGnrBuilder;
...
public class ContextAppIdGen {
	...
	// TODO : Strategy 객체를 Bean 등록 할 필요 있는지 확인 필요
	// 문제점 : 반복이 다수 발생 (다른 방안 생각 필요)
	// CHECK : 굳이 바꿀 필요가 있었나...
	...
	public EgovTableIdGnrServiceImpl egovWikiBookmarkIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(egovDataSource).setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
			.setBlockSize(10)
